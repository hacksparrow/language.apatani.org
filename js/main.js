...
var playSound = function (player, word) {
  ...
  var soundPath = '/sounds/words/'+ removeDiacritics(word)[0] + '/'+ voiceGender + '/' + word + '.mp3'
  ...
  var sound = soundManager.createSound({
    ...
    onload: function (success) {
      if (success) {
        $(player).removeClass('fa-volume-off').addClass('fa-volume-up')
      }
      else {
        $(player).removeClass('fa-volume-up').addClass('fa-volume-off')
        $(player).removeClass('playable').addClass('non-playable')
        $(player).css('color', 'gray')
      }
    },
    onfinish: function() {
      $(player).removeClass('fa-volume-up').addClass('fa-volume-off')
...
$(document).ready(function () {
  ...
  // add sound to syn. ant. and var. 
  $('.dictionary-content p').each(function (i, p) {

    var html = $(p).html()

    html.split('[').forEach(function (c) {
